...
if ($_GET['action']=="masquer") {
	$query = "UPDATE user SET lu='o' WHERE destinataire='$pseudo_ident'"; 
	// Execute la requete
	$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
}
...
$box19 = $_POST['box19'];
		...
		if(!empty($box0)) {
		$query = "UPDATE user SET val='1' WHERE id=$box0"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");


$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box0"; 
...
$message = "votre compte a été validé sur http://www.handicaperencontre.fr/  votre login_____ :".$pseudo ."___pour toutes question contactez moi par mail indiqué sur le site   à bientot http://www.handicaperencontre.fr/   "." votre mot de pass :".$pass;
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box1)) {
		$query = "UPDATE user SET val='1' WHERE id=$box1";
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box1"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box2)) {
		$query = "UPDATE user SET val='1' WHERE id=$box2"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box2"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box3)) {
		$query = "UPDATE user SET val='1' user WHERE id=$box3"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box3"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box4)) {
		$query = "UPDATE user SET val='1' WHERE id=$box4"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box4"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box5)) {
		$query = "UPDATE user SET val='1' WHERE id=$box5"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box5"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box6)) {
		$query = "UPDATE user SET val='1' WHERE id=$box6"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box6"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box7)) {
		$query = "UPDATE user SET val='1' WHERE id=$box7"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box7"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box8)) {
		$query = "UPDATE user SET val='1' WHERE id=$box8"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box8"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box9)) {
		$query = "UPDATE user SET val='1' WHERE id=$box9"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box9"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box10)) {
		$query = "UPDATE user SET val='1' WHERE id=$box10"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box10"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box11)) {
		$query = "UPDATE user SET val='1' WHERE id=$box11"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box11"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box12)) {
		$query = "UPDATE user SET val='1' WHERE id=$box12"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box12"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box13)) {
		$query = "UPDATE user SET val='1' WHERE id=$box13"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box13"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box14)) {
		$query = "UPDATE user SET val='1' WHERE id=$box14"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box14"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box15)) {
		$query = "UPDATE user SET val='1' WHERE id=$box15"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box15"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box16)) {
		$query = "UPDATE user SET val='1' WHERE id=$box16"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box16"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box17)) {
		$query = "UPDATE user SET val='1' WHERE id=$box17"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box17"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box18)) {
		$query = "UPDATE user SET val='1' WHERE id=$box18"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box18"; 
...
$to=$mail; $from="icedenice@live.fr\r\n";   //appel de la fonction mail (envoi):
 ...
 mail($mail,$sujet,$message,$headers); 
		...
		if(!empty($box19)) {
		$query = "UPDATE user SET val='1' WHERE id=$box19"; 
	// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");

$query = "SELECT mail,pseudo,pass FROM user WHERE id=$box19"; 
...
<form name="form1" method="post" action="val.php?action=suprimer">
        ...
        <td colspan="5" bgcolor="#FBE7F3"><form action="http://www.google.fr/cse" id="cse-search-box">
          ...
          <tr bgcolor="#96ACC2">
            <td width="160" align="left" valign="top" bgcolor="#FFFFFF"><table width="160"  border="1" cellpadding="2" cellspacing="0" bordercolor="#FFF2FF">
                ...
                <tr>
                  <td bgcolor="#FFDFFF"><div align="left"><span class="Style11">Vos user </span></div></td>
                </tr>
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><img src="img/open.gif" width="18" height="15" /> <a href="val.php">user re&ccedil;u (<? echo $nb_recu; ?>) </a></td>
                </tr>
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><img src="img/open.gif" width="18" height="15" /> <a href="message_envoyer.php">user envoy&eacute; (<? echo $nb_envoyer; ?>) </a></td>
                </tr>
                <tr>
            ...
            <td width="636" colspan="2" valign="top" bgcolor="#FFFFFF"><br />
              <table width="100%"  border="0" cellspacing="13" cellpadding="0">
                <tr>
                  <td bgcolor="#FFE8FB"><div align="center"><span class="Style11">::. Vos handicaperencontre.fr rencontre pour pour les personnes handicap&eacute;es Messages re&ccedil;u .:: </span></div></td>
                </tr>
                <tr bgcolor="#96ACC2">
                              ...
                              <td bgcolor="#FFE8FB"><table width="380" height="5" border="1" cellpadding="0" cellspacing="0">
                                  <tr>
                                    ...
                                    <td width="85"><div align="center">
                                        <input name="Submit4" type="submit" onclick="MM_goToURL('parent','val.php?action=cocher');return document.MM_returnValue" value="Tous cocher" />
                                    </div></td>
                              ...
                              <td bgcolor="#CCCCCC"><table width="100%" height="4" border="0" cellpadding="0" cellspacing="0">
                                  <tr>
                                    ...
                                    <td width="22%"><div align="center" class="Style16">
                                        <div align="left">user de : </div>
                                    </div></td>
                                    <td width="63%"><div align="center" class="Style16">
                                        <div align="left">departement  : </div>
                                    </div></td>
...
$query = "SELECT * FROM user  WHERE val <> 1 ORDER BY  'date_l' desc"; 
$compt=0;
// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
$fin = $start+20;
		...
		echo "	  <tr>
                            <td bgcolor='$couleur'><table width='619' height='26' border='0'>
                              <tr>
                                ...
                                <td width='40'><div align='center'><a href='message_lire.php?objet=$objet_envoi&message_heure=$message_heure'>- $message_heure   ville:$ville
 -</a> </div></td>
                              </tr>
                            </table></td>
                          </tr>";
...
?>
                            <tr>
                              <td bgcolor="#D8DFE7"><div align="center"><strong>
                                  <? if (mysql_num_rows($r)==0) { echo "<BR><BR>Pas de user re&ccedil;u ...<BR><BR><BR>"; } ?>
                              </strong></div></td>
                            </tr>
                            <tr>
...
$nb_ligne = mysql_num_rows($r);
				...
				echo "[ - ";
				while ($i< $nb_ligne) {
				echo "<a href='val.php?start=$i'>$page</a> ";
				echo " - ";
				$page=$page+1;
				$i=$i+20;
				}
