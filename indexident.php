          ...
          <table width="100%" height="100%"  border="0" cellpadding="1" cellspacing="1">
            <tr>
              <td width="57%" bgcolor="#FFFFFF"><table width="100%" height="107%"  border="0" cellpadding="1" cellspacing="0">
                <tr>
                  <td width="244" height="193" valign="top"><table width="100%" height="107%"  border="0" cellpadding="7" cellspacing="0">
                    <tr>
                      <td bgcolor="#FFEFFF"><p class="style35">personnes connect&eacute;s en ce moment:<br>
                        </p>
                          <?
...
if($i<$row = mysql_num_rows($l)) {
	...
	echo "<a href='profil.php?pseudo_envoi=$pseudoligne'>$pseudoligne</a>"." et "; 
				   ...
				   ?>
                    ...
                    <tr>
                      <td bgcolor="#FFEFFF"><p class="style35"> <span class="style31">jeux gratuit du site</span>&nbsp;<strong>
                          <input name="submit22" type="submit" onClick="MM_goToURL('parent','phpmine.php');return document.MM_returnValue" value="jouer D&eacute;mineur" la="la" partie="partie" />
                          <input name="submit222" type="submit" onClick="MM_goToURL('parent','morpion/index.php');return document.MM_returnValue" value="jouer Morpion" la="la" partie="partie" />
                      </strong></p></td>
                    </tr>
                  </table></td>
                </tr>
