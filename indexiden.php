      ...
      <tr bgcolor="#96ACC2">
        ...
        <td colspan="2" valign="top" bgcolor="#FFFFFF"><form name="form1" method="post" action="recherche_res.php">
          <table width="100%" height="100%"  border="0" cellpadding="1" cellspacing="1">
            <tr>
              <td width="57%" bgcolor="#FFEFFF"><table width="100%" height="107%"  border="0" cellpadding="7" cellspacing="0">
                <tr>
...
if($i<$row = mysql_num_rows($l)) {
	...
	echo "<a href='profil.php?pseudo_envoi=$pseudoligne'>$pseudoligne</a>"." et "; 
                ...
                <tr>
                  <td bgcolor="#FFEFFF"><p class="style35"> <span class="style36">jeux gratuit du site</span>&nbsp;<strong>
