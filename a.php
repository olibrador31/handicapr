...
if ($_GET['action']=="vider") {
	$query = "DELETE FROM user WHERE destinataire='$pseudo_ident'"; 
	// Execute la requete
	$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
}
...
$box0 = htmlspecialchars($_POST['box0']);
$box1 = htmlspecialchars($_POST['box1']);
$box2 = htmlspecialchars($_POST['box2']);
$box3 = htmlspecialchars($_POST['box3']);
$box4 = htmlspecialchars($_POST['box4']);
$box5 = htmlspecialchars($_POST['box5']);
$box6 = htmlspecialchars($_POST['box6']);
$box7 = htmlspecialchars($_POST['box7']);
$box8 = htmlspecialchars($_POST['box8']);
$box9 = htmlspecialchars($_POST['box9']);
$box10 = htmlspecialchars($_POST['box10']);
$box11 = htmlspecialchars($_POST['box11']);
$box12 = htmlspecialchars($_POST['box12']);
$box13 = htmlspecialchars($_POST['box13']);
$box14 = htmlspecialchars($_POST['box14']);
$box15 = htmlspecialchars($_POST['box15']);
$box16 = htmlspecialchars($_POST['box16']);
$box17 = htmlspecialchars($_POST['box17']);
$box18 = htmlspecialchars($_POST['box18']);
$box19 = htmlspecialchars($_POST['box19']);


		if(!empty($box0)) {
		$query = "DELETE FROM user WHERE id=$box0"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box1)) {
		$query = "DELETE FROM user WHERE id=$box1"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box2)) {
		$query = "DELETE FROM user WHERE id=$box2"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box3)) {
		$query = "DELETE FROM user WHERE id=$box3"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box4)) {
		$query = "DELETE FROM user WHERE id=$box4"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box5)) {
		$query = "DELETE FROM user WHERE id=$box5"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box6)) {
		$query = "DELETE FROM user WHERE id=$box6"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box7)) {
		$query = "DELETE FROM user WHERE id=$box7"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box8)) {
		$query = "DELETE FROM user WHERE id=$box8"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box9)) {
		$query = "DELETE FROM user WHERE id=$box9"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		...
		if(!empty($box10)) {
		$query = "DELETE FROM user WHERE id=$box10"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box11)) {
		$query = "DELETE FROM user WHERE id=$box11"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box12)) {
		$query = "DELETE FROM user WHERE id=$box12"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box13)) {
		$query = "DELETE FROM user WHERE id=$box13"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box14)) {
		$query = "DELETE FROM user WHERE id=$box14"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box15)) {
		$query = "DELETE FROM user WHERE id=$box15"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box16)) {
		$query = "DELETE FROM user WHERE id=$box16"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box17)) {
		$query = "DELETE FROM user WHERE id=$box17"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box18)) {
		$query = "DELETE FROM user WHERE id=$box18"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
		if(!empty($box19)) {
		$query = "DELETE FROM user WHERE id=$box19"; 
		// Execute la requete
		$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
		}
...
<form name="form1" method="post" action="a.php?action=suprimer">
        ...
        <td colspan="5" bgcolor="#FBE7F3"><form action="http://www.google.fr/cse" id="cse-search-box">
          ...
          <tr bgcolor="#96ACC2">
            <td width="160" align="left" valign="top" bgcolor="#FFFFFF"><table width="160"  border="1" cellpadding="2" cellspacing="0" bordercolor="#FFF2FF">
                <tr>
                  <td bgcolor="#FFFFFF"><a href="mailsupr.php">suprimer mail </a></td>
                </tr>
                <tr>
                  <td bgcolor="#FFFFFF"><div align="center" class="Style23"><a href="val.php" class="Style24">Valider profil </a></div></td>
                </tr>
                <tr>
                  <td bgcolor="#FFDFFF"><div align="left"><span class="Style11">Vos user </span></div></td>
                </tr>
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><img src="img/open.gif" width="18" height="15" /> <a href="a.php">user re&ccedil;u (<? echo $nb_recu; ?>) </a></td>
                </tr>
                <tr>
                ...
                <tr bordercolor="#FFE8FB">
                  <td bgcolor="#FFFFFF"><a href="profilval.php?pseudo_envoi=<? echo $pseudo_ident; ?>" class="Style11">- Votre profil </a></td>
                </tr>
                <tr bordercolor="#FFE8FB">
                              ...
                              <td bgcolor="#FFE8FB"><table width="380" height="5" border="1" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td width="69"><div align="center">
                                        <input name="Submit" type="submit" value="Suprimer" />
                                    </div></td>
                                    <td width="85"><div align="center">
                                        <input name="Submit4" type="submit" onclick="MM_goToURL('parent','a.php?action=cocher');return document.MM_returnValue" value="Tous cocher" />
                                    </div></td>
...
$query = "SELECT * FROM user  WHERE val <> 1 ORDER BY  'departement' desc"; 
$compt=0;
// Execute la requete
$r = mysql_query($query) or die ("Pas pris en compte, votre message/sujet/pseudo ne doit pas contenir d'apostrephe !!!");
$fin = $start+20;
		...
		echo "	  <tr>
                            <td bgcolor='$couleur'><table width='619' height='26' border='0'>
                              <tr>
                                ...
                                <td width='132'><a href='profilval.php?pseudo_envoi=$pseudo_expediteur'>$pseudo_expediteur  </a></td>
                                <td width='385'><a href='message_lire.php?objet=$objet_envoi&message_heure=$message_heure'>$objet_reduit </a></td>
                                <td width='40'><div align='center'><a href='message_lire.php?objet=$objet_envoi&message_heure=$message_heure'>- $message_heure   ville:$ville</a> </div></td>
                              </tr>
                            </table></td>
                          </tr>";
...
$nb_ligne = mysql_num_rows($r);
				...
				echo "[ - ";
				while ($i< $nb_ligne) {
				echo "<a href='a.php?start=$i'>$page</a> ";
				echo " - ";
				$page=$page+1;
				$i=$i+20;
				}
